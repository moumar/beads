package net.beadsproject.beads.ugens.effect;

import net.beadsproject.beads.core.*;
import net.beadsproject.beads.data.*;
import net.beadsproject.beads.ugens.core.Gain;
import net.beadsproject.beads.ugens.filter.AllpassFilter;
import net.beadsproject.beads.ugens.filter.OnePoleFilter;
import net.beadsproject.beads.ugens.synth.RandomPWM;
