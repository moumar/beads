...
import net.beadsproject.beads.ugens.filter.BiquadFilter;
import net.beadsproject.beads.ugens.lowlevel.RMS;
...
public class Compressor extends UGen implements DataBeadReceiver {
	...
	public Compressor setSideChain(UGen sideChain) {
		pf = (new BiquadFilter(context, BiquadFilter.BUTTERWORTH_LP))
				.setFreq(31);
		if (sideChain == null) {
