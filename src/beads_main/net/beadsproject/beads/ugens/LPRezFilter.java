...
/**
 * A simple 2nd-order resonant low-pass filter. Faster than a BiquadFilter because
 * its algorithm is of the form:
 *
 * y(n) = b0 * x(n) + a1 * y(n-1) + a2 * y(n-2);
 * 
 * so it doesn't compute unnecessary parts of the biquad formula.
 * 
 * Takes two parameters: cut-off frequency and resonance (0 for no resonance, 1 for maximum resonance).
 * 
...
public class LPRezFilter extends UGen {
	...
	/**
	 * Constructor for frequency specified by a UGen and resonance specified by a float.
	 * @param con	The audio context.
	...
	/**
	 * Constructor for frequency specified by a float and resonance specified by a UGen.
	 * @param con	The audio context.
	 * @param freq	The filter cut-off frequency.
	...
	/**
	 * Sets the filter resonance to a float value. This removes the resonance UGen, if it exists.
